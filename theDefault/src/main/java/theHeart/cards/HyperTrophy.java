...
public class HyperTrophy extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(HyperTrophy.class.getSimpleName());
    ...
    // /STAT DECLARATION/
    //Card crashes when attempting to upgrade, with temp hp increase damage taken preferably?
