...
//Borrowed Thorton's Fortune X-Cost card Action.
    ...
    /*    */   public ElementalChargeAction(AbstractPlayer p, AbstractMonster m,int[] multiDamage,int amount, boolean freeToPlayOnce, int energyOnUse) {
        /* 21 */     this.p = p;
        /* 22 */     this.m = m;
        /* 23 */     this.freeToPlayOnce = freeToPlayOnce;
        /* 24 */     this.upgraded = upgraded;
        /* 25 */     this.duration = Settings.ACTION_DUR_XFAST;
        /* 26 */     this.actionType = AbstractGameAction.ActionType.SPECIAL;
        /* 27 */     this.energyOnUse = energyOnUse;
