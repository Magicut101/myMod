...
import theHeart.patches.relics.BottledPlaceholderField;
import theHeart.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theHeart.DefaultMod.makeRelicOutlinePath;
import static theHeart.DefaultMod.makeRelicPath;
